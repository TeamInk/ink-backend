...
INSERT INTO badge (badge_id, content, name) VALUES (1, '잉크 3일입니다.', '잉크 3일');
INSERT INTO badge (badge_id, content, name) VALUES (2, '셀럽 잉크입니다.', '셀럽 잉크');
INSERT INTO badge (badge_id, content, name) VALUES (3, '학구정 잉크입니다.', '학구적 잉크');
INSERT INTO badge (badge_id, content, name) VALUES (4, '잉크 셋입니다.', '잉크 셋');
...
INSERT INTO member_report (report_id, reporter_id, target_id, reason, hide_to_reporter, reg_date) VALUES (1, 1, 2, 'Inappropriate content', true, '2023-10-01 10:00:00');
INSERT INTO member_report (report_id, reporter_id, target_id, reason, hide_to_reporter, reg_date) VALUES (2, 2, 3, 'Spam', true, '2023-10-02 11:00:00');
INSERT INTO member_report (report_id, reporter_id, target_id, reason, hide_to_reporter, reg_date) VALUES (3, 3, 1, 'Harassment', true, '2023-10-03 12:00:00');

-- Add dummy data for reply_report table
INSERT INTO reply_report (report_id, reply_id, reporter_id, reason, hide_to_reporter, reg_date, status) VALUES (1, 1, 1, 'Offensive language', false, '2023-10-01 10:00:00', 'PENDING');
INSERT INTO reply_report (report_id, reply_id, reporter_id, reason, hide_to_reporter, reg_date, status) VALUES (2, 2, 2, 'Spam', false, '2023-10-02 11:00:00', 'PENDING');
INSERT INTO reply_report (report_id, reply_id, reporter_id, reason, hide_to_reporter, reg_date, status) VALUES (3, 3, 3, 'Harassment', false, '2023-10-03 12:00:00', 'PENDING');